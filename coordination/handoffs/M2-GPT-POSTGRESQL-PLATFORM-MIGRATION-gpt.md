...
- Implementation head SHA: `3b33534` (`2e04f3b` platform cutover, `518f10d` clean-runner CI fix, `3b33534` npm 10 lock correction)
- Writer/tester: GPT
- Date: 2026-07-15
...
| npm 10.9.4 `npm ci --dry-run` | PASS after lock correction; explicit exit 0 |
...
GitHub CI run 26 initially stopped at `npm ci`: the lock generated by local npm 11 omitted
`@swc/helpers@0.5.23`, which npm 10 on the Node 22 runner requires in the lock graph. The lock was
regenerated with npm 10.9.4 and both npm 10 and npm 11 clean-install resolution were rechecked.
