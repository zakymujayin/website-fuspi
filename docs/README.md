...
> **Batas identitas:** website yang dibangun adalah milik **FUSPI**. Situs FUDA (`fuda.uinbanten.ac.id`) hanya boleh dipakai sebagai referensi audit struktur/konten dan inspirasi visual; nama fakultas, domain, email, data prodi, seed, metadata, serta copy publik tidak boleh mengambil identitas FUDA.
...
4. `03-design-system.md` dan `17-komponen-ui-detail.md` untuk tampilan dan interaksi.
5. `20-test-acceptance-go-live.md` untuk bukti kelulusan dan gerbang go-live.
...
| `20-test-acceptance-go-live.md` | **Test plan & gerbang go-live** — unit, integration, security, E2E, migrasi, restore, acceptance |
...
8. Migrasi WordPress + media + redirect 301 (`13`)
