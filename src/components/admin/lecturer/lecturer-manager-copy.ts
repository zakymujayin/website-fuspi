export const LECTURER_MANAGER_COPY = {
  ...
  ar: {
    education: {
      title: "المؤهلات العلمية", description: "إدارة المؤهلات الأكاديمية الظاهرة في الملف العام للمحاضر.", degree: "الدرجة", field: "مجال الدراسة", institution: "المؤسسة", city: "المدينة", year: "السنة", add: "إضافة مؤهل", save: "حفظ التغييرات", remove: "حذف", addTitle: "إضافة مؤهل علمي", empty: "لا توجد مؤهلات علمية بعد.", saved: "تم حفظ المؤهل.", error: "لم يُحفظ التغيير. راجع الحقول وحاول مرة أخرى.",
    ...
    publication: {
      title: "المنشورات", description: "إدارة الأعمال العلمية الظاهرة في ملف المحاضر.", name: "عنوان المنشور", type: "النوع", year: "السنة", publisher: "الناشر / المجلة", url: "الرابط", doi: "DOI", add: "إضافة منشور", save: "حفظ التغييرات", remove: "حذف", addTitle: "إضافة منشور", empty: "لا توجد منشورات بعد.", saved: "تم حفظ المنشور.", error: "لم يُحفظ التغيير. راجع الحقول وحاول مرة أخرى.",
