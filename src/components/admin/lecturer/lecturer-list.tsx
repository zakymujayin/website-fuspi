...
const copy = {
  id: {
    ...
    programNames: { IAT: "Ilmu Al-Qur’an dan Tafsir", IH: "Ilmu Hadis", AFI: "Aqidah dan Filsafat Islam" },
  },
  en: {
    ...
    programNames: { IAT: "Qur’anic Sciences and Tafsir", IH: "Hadith Studies", AFI: "Aqidah and Islamic Philosophy" },
  },
  ar: {
    ...
    programNames: { IAT: "علوم القرآن والتفسير", IH: "دراسات الحديث", AFI: "العقيدة والفلسفة الإسلامية" },
  },
} as const;
