...
export default async function NewPartnershipPage({ params }: Props) {
  ...
  const decision = decideProtectedRoute(session, appLocale, `/${appLocale}/admin/kerjasama/baru`);
  ...
  return (
    <section aria-labelledby="admin-partnership-create-title" className="flex flex-col gap-6">
      <div>
        <h1 id="admin-partnership-create-title" className="section-rule font-display text-2xl text-slate-900">
          {t("PARTNERSHIP.title")}
        </h1>
